...
create table material (mt_id char(9) not null,mt_title varchar(50) not null,mt_isbn varchar(20),mt_publisher varchar(100) not null,mt_publish_date date not null, mt_edition int ,mt_pageno int,mt_sh_id char(4) not null,mt_price decimal(8, 2) not null,mt_type varchar(15),primary key (mt_id),foreign key (mt_sh_id) references shelf(sh_id))
insert into material('mt0000001','An Introduction to General, Organic, and Biological Chemistry (12th Edition)','9780321908445','Pearson','2014-01-01',12,'','sh01',1036.88,'Chemistry')
insert into material('mt0000002','Basic Chemistry (5th Edition)','9780134138046','Pearson','2014-01-01','','sh01',1036.88,'Chemistry')
             

create table material_copy(mc_id char(10) not null,mc_mt_id char(10) not null,mc_status varchar(8) not null, primary key (mc_id),foreign key (mc_mt_id) references material(mt_id))


create table shelf(sh_id char(4) not null,sh_no int not null,sh_row int not null,primary key (sh_id))
insert into shelf('sh01',1,1)
insert into shelf('sh02',1,2)
insert into shelf('sh03',1,3)
insert into shelf('sh04',2,1)
insert into shelf('sh05',2,2)
insert into shelf('sh06',2,3)
